...
def _install_apt_packages(runner: Runner, config: Config) -> None:
    ...
    # Add Neovim unstable PPA if not present (Ubuntu only, not Debian)
    # PPAs are Ubuntu-specific and require software-properties-common
    if config.is_ubuntu:
        ...
        console.info("Skipping PPA setup (Debian uses default repositories)")
